...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-7i6dyjy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-7i6dyjy.containers.anotherwebservice.com/
...
```
git clone git@github.com:pieroap21/container-7i6dyjy.git
cd container-7i6dyjy
```
...
```
docker attach container-7i6dyjy
```
